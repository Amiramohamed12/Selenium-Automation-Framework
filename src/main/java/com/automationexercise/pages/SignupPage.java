...
public class SignupPage {
    ...
    //locators
    private final By genderMale=By.id("id_gender1");
    private final By genderFemale=By.id("id_gender2");
    ...
    private final By createAccountSuccessMessage = By.tagName("b");
    ...
    //actions
    @Step("Choose title {title}") //Mr - Mrs (dynamic locator)
    private void chooseTitle(String title) {
    ...
    //validation
    @Step("Verify create account success message")
    public SignupPage verifyAccountCreated() {
        driver.verification().isElementVisible(createAccountSuccessMessage);
        return this;
    }
