...
import com.automationexercise.utils.TermnialUtils;
...
import static com.automationexercise.report.AllureConstants.HISTORY_FOLDER;
import static com.automationexercise.report.AllureConstants.RESULTS_HISTORY_FOLDER;
...
public class AllureReportGenerator {
    ...
    public static void generateReports(boolean isSingleFile) {
        ...
        TermnialUtils.executeTerminalCommand(command.toArray(new String[0]));
    }
    ...
    public static void openReport(String reportFileName) {
        ...
        switch (OSUtils.getCurrentOS()) {
            case WINDOWS -> TermnialUtils.executeTerminalCommand("cmd.exe", "/c", "start", reportPath.toString());
            case MAC, LINUX -> TermnialUtils.executeTerminalCommand("open", reportPath.toString());
